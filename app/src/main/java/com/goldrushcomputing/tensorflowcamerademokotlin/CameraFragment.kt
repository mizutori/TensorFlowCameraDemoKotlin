...
class CameraFragment : Fragment() , ActivityCompat.OnRequestPermissionsResultCallback{
    ...
    private fun setUpCameraOutputs(width: Int, height: Int) {
        activity?.let{activity ->
            ...
            try {
                ...
                builder.setTitle(R.string.camera_error)
    ...
    private fun startBackgroundThread() {
        backgroundThread = HandlerThread(HANDLE_THREAD_NAME).also {
            it.start()
    ...
    private fun classifyFrame() {
        ...
        textureView?.getBitmap(ImageClassifier.DIM_IMG_SIZE_X, ImageClassifier.DIM_IMG_SIZE_Y)?.also {bitmap ->
            classifier?.classifyFrame(bitmap)?.also {result ->
                showToast(result)
            }
            bitmap.recycle()
        }
